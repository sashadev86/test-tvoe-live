  ...
  mediaList: [
    {
      ...
      genre: "Ужасы",
      genres: ["Фентези", "Комедия", "Криминал", "Детектив", "Ужасы"],
      isNewRelease: true,
    ...
    },
    {
      ...
      isNewRelease: true,
      thumbnail: "/img/films-posters/oceans-eight/oceans-eight.png",
      details: {
        imgBg: null,
        imgTitleLogo: null,
      },
    ...
    },
    {
      ...
      year: 2021,
      content:
        "В сказочной глубинке Колумбии живет большая семья Мадригаль с волшебными способностями.",
      description:
      ...
      genre: "Мультфильм",
      genres: ["Мультфильм", "Мюзикл", "Фэнтези", "Комедия", "Семейный"],
      isNewRelease: false,
      thumbnail: "/img/films-posters/encanto/encanto.webp",
      details: {
        imgBg: null,
        imgTitleLogo: null,
      },
    ...
    },
    {
      ...
      year: 2023,
      content:
        "'Пять ночей у Фредди' - американский сверхъестественный фильм ужасов 2023 года, основанный на серии видеоигр 'Пять ночей у Фредди'",
      description:
      ...
      isNewRelease: true,
      thumbnail:
        "/img/films-posters/five-nights-at-freddys/five-nights-at-freddys.png",
      details: {
        imgBg: null,
        imgTitleLogo: null,
      },
